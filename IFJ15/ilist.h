...
#define I_GET_RETURN 141
#define I_GOTO_INSTR 142
#define I_SUBSTR2 143
// 3 adresny kod
typedef struct
{
...
typedef struct funcItemList
{
  tInstr instr;
  struct itemList *nextItem;
  struct funcItemList *nextFuncItem;
} tFuncItemList;

typedef struct
{
  struct funcItemList *first;  //ukazatel na prvni prvek
  struct funcItemList *last;   //ukazatel na posledni prvek
  struct funcItemList *active; //ukazatel na aktivni prvek
} tFuncList;
